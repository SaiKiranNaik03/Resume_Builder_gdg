  ...
  return (
    ...
    >
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {[
            ...
            <Card key={index} className="bg-gray-800 border-teal-500 shadow-lg">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            "AI generates an optimized resume instantly.",
            "Customize using templates and expert recommendations.",
            "Download and apply with confidence!",
          ].map((step, index) => (
            <Card
              key={index}
              className="bg-gray-800 border-blue-500 shadow-lg hover:shadow-xl transition-all"
            >
              <CardContent className="text-lg text-white p-6">
                {step}
              </CardContent>
            </Card>
          ))}
      ...
      <div className="my-12 text-center">
        ...
        <motion.div
          key={index}
          className="relative max-w-3xl mx-auto bg-gray-800 p-6 rounded-lg shadow-lg italic text-gray-300"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          exit={{ opacity: 0, y: -10 }}
          transition={{ duration: 0.5 }}
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6">
          {[
            ...
            <Button
              asChild
              key={index}
              className="bg-black text-white border  border-teal-400 hover:scale-110 hover:drop-shadow-[0_0_10px_rgba(45,212,191,0.8)] duration-300 ease-in-out"
            >
              <a href={item.link} target="_blank" rel="noopener noreferrer">
                {item.text}
                <ArrowUpRightSquare className="ml-2 w-4 h-4" />
              </a>
            </Button>
          ))}
        </div>
